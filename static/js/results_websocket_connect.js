function startAnalysis(updateBtn, selWr, selWq, selModel) {
...
startAnalysis("#update-btn", "#sel_wr", "#select_wq", "#sel_model");
startAnalysis("#update-btn-sp", "#sel_wr_sp", "#select_wq_sp", "#sel_model_sp");